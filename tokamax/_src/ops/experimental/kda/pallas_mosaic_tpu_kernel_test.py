...
_CASES = [
    ...
    _chunk_api_case("single_head_fp32", B=2, T=128, H=2, D=32),
...
_CASES.extend(
    [
        ...
        _chunk_fwd_case(f"e2e_7", B=1, T=64, H=2, D=32,use_initial_state=True, output_final_state=True, dtype=jnp.bfloat16),
